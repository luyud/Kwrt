...
coremark wget-ssl curl autocore htop nano zram-swap kmod-lib-zstd kmod-tcp-bbr bash openssh-sftp-server block-mount resolveip ds-lite swconfig luci-app-fan luci-app-filemanager luci-app-iperf3-server luci-app-nikki luci-app-tailscale-community luci-app-oaf luci-app-vlmcsd /" include/target.mk
